window.onload = () => {
    const btnD = document.getElementById("dog");
    addEventListener("click", obtenerDoges ,false);
    const btnC = document.getElementById("cat");
    addEventListener("click", obtenerGatos ,false);
    let btn = document.getElementById("animal");
    addEventListener("click", dogesYCatesEnParalelo, false);
  };
